...
1.  Clone the repository:
    ```bash
    git clone https://github.com/NeerajRanjan/timeline_builder_2026.git
...
Generated exports from the application:

<p align="center">
  <img src="public/summary-preview.png" alt="2026 Master Plan Summary" width="45%" />
  <img src="public/wallpaper-preview.png" alt="Mobile Wallpaper" width="45%" />
</p>

## License

This project is free to use and does not contains any license (but credit will be plus point but its upto you entirely).

## Contact

- **Twitter**: [NeerajRanjan](https://x.com/Neeraj___Ranjan)
- **Instagram**: [Neeraj__Ranjan](https://instagram.com/Neeraj__Ranjan)
- **GitHub**: [NeerajRanjan](https://github.com/NeerajRanjan)
- **Live Demo**: [Timeline Builder 2026](https://timeline-builder-2026.vercel.app/)
